...
- [CONTAINS](../Azure_IAM_Edges/CONTAINS/application-to-sp.md) - Corresponding service principal

### Incoming

- [OWNS](../Azure_IAM_Edges/OWNS/application-ownership.md) - Application owners
...
- [Data Schema](../Azure_IAM_Edges/data-schema.md#24-azure_adapplications-array) - JSON input format
...
- [Application Ownership](../Azure_IAM_Edges/OWNS/application-ownership.md) - Ownership edges
