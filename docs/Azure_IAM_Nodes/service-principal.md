...
- [HAS_PERMISSION](../Azure_IAM_Edges/HAS_PERMISSION/) - Role assignments, Graph API permissions
- [CAN_ESCALATE](../Azure_IAM_Edges/CAN_ESCALATE/) - Privilege escalation paths via permissions

### Incoming

- [OWNS](../Azure_IAM_Edges/OWNS/service-principal-ownership.md) - SP owners
- [CONTAINS](../Azure_IAM_Edges/CONTAINS/application-to-sp.md) - Parent application
- [CONTAINS](../Azure_IAM_Edges/CONTAINS/mi-to-sp.md) - Parent managed identity
...
- [Data Schema](../Azure_IAM_Edges/data-schema.md#23-azure_adserviceprincipals-array) - JSON input format
- [Application Nodes](application.md) - Parent application objects
- [Application CONTAINS SP](../Azure_IAM_Edges/CONTAINS/application-to-sp.md) - Relationship edge
- [SP Ownership](../Azure_IAM_Edges/OWNS/service-principal-ownership.md) - Ownership edges
