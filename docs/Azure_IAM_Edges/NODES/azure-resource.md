...
- [CONTAINS](../CONTAINS/resource-to-system-mi.md) - System-assigned managed identity (synthetic)
- [CAN_ESCALATE](../CAN_ESCALATE/) - To user-assigned MIs (via IMDS token theft)
...
- [RG CONTAINS Resource](../CONTAINS/rg-to-resource.md) - Parent edge
- [Resource CONTAINS System MI](../CONTAINS/resource-to-system-mi.md) - Identity edge
