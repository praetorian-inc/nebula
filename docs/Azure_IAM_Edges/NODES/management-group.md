...
- [CONTAINS](../CONTAINS/mg-to-child-mg.md) - Child management groups
- [CONTAINS](../CONTAINS/mg-to-subscription.md) - Subscriptions

### Incoming

- [CONTAINS](../CONTAINS/tenant-to-root-mg.md) - Parent tenant (root MG only)
- [CONTAINS](../CONTAINS/mg-to-child-mg.md) - Parent management group
...
- [Data Schema](../data-schema.md#4-management_groups-array) - JSON input format
- [Tenant Node](tenant.md) - Parent of root MG
- [Subscription Nodes](subscription.md) - Children of MGs
- [Tenant CONTAINS Root MG](../CONTAINS/tenant-to-root-mg.md) - Parent edge
- [MG CONTAINS Child MG](../CONTAINS/mg-to-child-mg.md) - Hierarchy edges
- [MG CONTAINS Subscription](../CONTAINS/mg-to-subscription.md) - Subscription edges
