...
**Scan Date:** 2026-02-11 00:30:54 +08
**Total Findings:** 19
...
| Database Azure Services Access Detection | 2 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| 8667a2e9\-e289\-4b54\-96ea\-36ee334e0fae | microsoft\.authorization/roledefinitions |  | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | roleName: Nebula Dangerous Custom Role<br>roleDescription: Extremely dangerous custom role with excessive permissions for testing<br>assignableScopes: /subscriptions/55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051<br>dangerousAction: \* |  |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| sttakeovergmeima | microsoft\.storage/storageaccounts | eastus2 | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | defaultAction: Allow<br>virtualNetworkRules: none<br>hasIpRules: 0<br>hasVnetRules: 0<br>ipRules: none<br>publicNetworkAccess: Enabled<br>allowBlobPublicAccess: true | **Command:** curl \-i 'https://sttakeovergmeima\.blob\.core\.windows\.net/?comp=list' \-\-max\-time 3<br>**Description:** Test anonymous access to storage account container listing<br>**Expected:** anonymous access enabled = 404 \| anonymous access disabled = 401/403 \| public access disabled = 409<br>**Actual:** Body: ﻿<?xml version="1\.0" encoding="utf\-8"?\><Error\><Code\>ResourceNotFound</Code\><Message\>The specified resource does not exist\.<br>RequestId:87c12e3f\-701e\-00d3\-0aaa\-9ac605000000<br>Time:2026\-02\-10T16:31:35\.6705309Z</Message\></Error\><br>**Exit Code:** 404 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| nebulatestenricher1019 | microsoft\.containerregistry/registries | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | resourceGroup: nebula\-enricher\-test\-acr<br>anonymousPullEnabled: 1<br>adminUserEnabled: 0<br>loginServer: nebulatestenricher1019\.azurecr\.io<br>publicNetworkAccess: enabled | **Command:** TOKEN=$\(echo \-en 'https://nebulatestenricher1019\.azurecr\.io/oauth2/token?service=nebulatestenricher1019\.azurecr\.io&scope=registry:catalog:\*' \| xargs curl \-s \| jq \-r \.access\_token\); curl \-H 'Authorization: Bearer '$TOKEN 'https://nebulatestenricher1019\.azurecr\.io/v2/\_catalog'<br>**Description:** Test anonymous OAuth2 token \+ repository catalog access \(definitive anonymous pull test\)<br>**Expected:** Success with repositories list = anonymous pull enabled \| Token failure = anonymous access disabled \| 401/403 = secured<br>**Actual:** ✓ ANONYMOUS ACCESS CONFIRMED \| Repositories: \{"repositories":null\}<br><br>**Exit Code:** 200<br><br>**Command:** docker pull nebulatestenricher1019\.azurecr\.io/\[REPOSITORY\_NAME\]<br>**Description:** Test anonymous Docker pull of repository: \[REPOSITORY\_NAME\]<br>**Expected:** Pull successful = anonymous access enabled \| Authentication required = secured \| Not found = repository doesn't exist<br>**Actual:** Manual execution required \- requires Docker CLI<br>**Exit Code:** 0<br><br>**Command:** az acr show \-\-name nebulatestenricher1019 \-\-query '\{loginServer:loginServer,adminUserEnabled:adminUserEnabled,publicNetworkAccess:publicNetworkAccess,anonymousPullEnabled:anonymousPullEnabled\}'<br>**Description:** Azure CLI command to check registry configuration \(including anonymous pull setting\)<br>**Expected:** Registry details = accessible via Azure API \| Error = access denied or registry not found<br>**Actual:** Manual execution required \- requires Azure CLI authentication<br>**Exit Code:** 0 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| nebulatestenricher0930 | microsoft\.containerregistry/registries | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | sku: <nil\><br>adminUserEnabled: false<br>loginServer: nebulatestenricher0930\.azurecr\.io<br>publicNetworkAccess: enabled<br>allowAnonymousPull: false | **Command:** TOKEN=$\(echo \-en 'https://nebulatestenricher0930\.azurecr\.io/oauth2/token?service=nebulatestenricher0930\.azurecr\.io&scope=registry:catalog:\*' \| xargs curl \-s \| jq \-r \.access\_token\); curl \-H 'Authorization: Bearer '$TOKEN 'https://nebulatestenricher0930\.azurecr\.io/v2/\_catalog'<br>**Description:** Test anonymous OAuth2 token \+ repository catalog access \(definitive anonymous pull test\)<br>**Expected:** Success with repositories list = anonymous pull enabled \| Token failure = anonymous access disabled \| 401/403 = secured<br>**Actual:** Anonymous token request failed: token request failed: HTTP 401, \{"errors":\[\{"code":"UNAUTHORIZED","message":"authentication required, visit https://aka\.ms/acr/authorization for more information\. CorrelationId: 86d1af30\-f4de\-44e7\-952a\-1375687786ca"\}\]\}<br>**Exit Code:** 401<br>**Error:** token request failed: HTTP 401, \{"errors":\[\{"code":"UNAUTHORIZED","message":"authentication required, visit https://aka\.ms/acr/authorization for more information\. CorrelationId: 86d1af30\-f4de\-44e7\-952a\-1375687786ca"\}\]\}<br><br>**Command:** docker pull nebulatestenricher0930\.azurecr\.io/\[REPOSITORY\_NAME\]<br>**Description:** Test anonymous Docker pull of repository: \[REPOSITORY\_NAME\]<br>**Expected:** Pull successful = anonymous access enabled \| Authentication required = secured \| Not found = repository doesn't exist<br>**Actual:** Manual execution required \- requires Docker CLI<br>**Exit Code:** 0<br><br>**Command:** az acr show \-\-name nebulatestenricher0930 \-\-query '\{loginServer:loginServer,adminUserEnabled:adminUserEnabled,publicNetworkAccess:publicNetworkAccess,anonymousPullEnabled:anonymousPullEnabled\}'<br>**Description:** Azure CLI command to check registry configuration \(including anonymous pull setting\)<br>**Expected:** Registry details = accessible via Azure API \| Error = access denied or registry not found<br>**Actual:** Manual execution required \- requires Azure CLI authentication<br>**Exit Code:** 0 |
| nebulatestenricher1019 | microsoft\.containerregistry/registries | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | sku: <nil\><br>loginServer: nebulatestenricher1019\.azurecr\.io<br>publicNetworkAccess: enabled<br>adminUserEnabled: false<br>allowAnonymousPull: true | **Command:** TOKEN=$\(echo \-en 'https://nebulatestenricher1019\.azurecr\.io/oauth2/token?service=nebulatestenricher1019\.azurecr\.io&scope=registry:catalog:\*' \| xargs curl \-s \| jq \-r \.access\_token\); curl \-H 'Authorization: Bearer '$TOKEN 'https://nebulatestenricher1019\.azurecr\.io/v2/\_catalog'<br>**Description:** Test anonymous OAuth2 token \+ repository catalog access \(definitive anonymous pull test\)<br>**Expected:** Success with repositories list = anonymous pull enabled \| Token failure = anonymous access disabled \| 401/403 = secured<br>**Actual:** ✓ ANONYMOUS ACCESS CONFIRMED \| Repositories: \{"repositories":null\}<br><br>**Exit Code:** 200<br><br>**Command:** docker pull nebulatestenricher1019\.azurecr\.io/\[REPOSITORY\_NAME\]<br>**Description:** Test anonymous Docker pull of repository: \[REPOSITORY\_NAME\]<br>**Expected:** Pull successful = anonymous access enabled \| Authentication required = secured \| Not found = repository doesn't exist<br>**Actual:** Manual execution required \- requires Docker CLI<br>**Exit Code:** 0<br><br>**Command:** az acr show \-\-name nebulatestenricher1019 \-\-query '\{loginServer:loginServer,adminUserEnabled:adminUserEnabled,publicNetworkAccess:publicNetworkAccess,anonymousPullEnabled:anonymousPullEnabled\}'<br>**Description:** Azure CLI command to check registry configuration \(including anonymous pull setting\)<br>**Expected:** Registry details = accessible via Azure API \| Error = access denied or registry not found<br>**Actual:** Manual execution required \- requires Azure CLI authentication<br>**Exit Code:** 0 |
| acrtest770646224 | microsoft\.containerregistry/registries | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | publicNetworkAccess: enabled<br>allowAnonymousPull: false<br>loginServer: acrtest770646224\.azurecr\.io<br>adminUserEnabled: false<br>sku: <nil\> | **Command:** TOKEN=$\(echo \-en 'https://acrtest770646224\.azurecr\.io/oauth2/token?service=acrtest770646224\.azurecr\.io&scope=registry:catalog:\*' \| xargs curl \-s \| jq \-r \.access\_token\); curl \-H 'Authorization: Bearer '$TOKEN 'https://acrtest770646224\.azurecr\.io/v2/\_catalog'<br>**Description:** Test anonymous OAuth2 token \+ repository catalog access \(definitive anonymous pull test\)<br>**Expected:** Success with repositories list = anonymous pull enabled \| Token failure = anonymous access disabled \| 401/403 = secured<br>**Actual:** Anonymous token request failed: token request failed: HTTP 401, \{"errors":\[\{"code":"UNAUTHORIZED","message":"authentication required, visit https://aka\.ms/acr/authorization for more information\. CorrelationId: 9da77196\-ba78\-4802\-8f56\-db712a5906b8"\}\]\}<br>**Exit Code:** 401<br>**Error:** token request failed: HTTP 401, \{"errors":\[\{"code":"UNAUTHORIZED","message":"authentication required, visit https://aka\.ms/acr/authorization for more information\. CorrelationId: 9da77196\-ba78\-4802\-8f56\-db712a5906b8"\}\]\}<br><br>**Command:** docker pull acrtest770646224\.azurecr\.io/\[REPOSITORY\_NAME\]<br>**Description:** Test anonymous Docker pull of repository: \[REPOSITORY\_NAME\]<br>**Expected:** Pull successful = anonymous access enabled \| Authentication required = secured \| Not found = repository doesn't exist<br>**Actual:** Manual execution required \- requires Docker CLI<br>**Exit Code:** 0<br><br>**Command:** az acr show \-\-name acrtest770646224 \-\-query '\{loginServer:loginServer,adminUserEnabled:adminUserEnabled,publicNetworkAccess:publicNetworkAccess,anonymousPullEnabled:anonymousPullEnabled\}'<br>**Description:** Azure CLI command to check registry configuration \(including anonymous pull setting\)<br>**Expected:** Registry details = accessible via Azure API \| Error = access denied or registry not found<br>**Actual:** Manual execution required \- requires Azure CLI authentication<br>**Exit Code:** 0 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| nebula\-tier1\-test\-mysql\-public\-lctesnjm | microsoft\.dbformysql/flexibleservers | westus2 | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | resourceGroup: nebula\-tier1\-test\-rg\-lctesnjm | **Description:** Check MySQL Flexible Server for AllowAllAzureIps rule and public access<br>**Actual:** OK: Allow Azure services disabled \- AllowAllAzureIps rule not found<br>**Exit Code:** 0 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| eh\-test\-770646676 | microsoft\.eventhub/namespaces | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | publicNetworkAccess: enabled<br>resourceGroup: rg\-test\-storage<br>defaultAction: allow<br>sku: <nil\><br>endpoint: https://eh\-test\-770646676\.servicebus\.windows\.net:443/<br>zoneRedundant: true | **Command:** curl \-i 'https://eh\-test\-770646676\.servicebus\.windows\.net/$management' \-\-max\-time 10<br>**Description:** Test anonymous access to Event Hub management endpoint<br>**Expected:** 401 = authentication required \| 200 = anonymous access \(misconfiguration\) \| 404 = not found<br>**Actual:** Body: <feed xmlns="http://www\.w3\.org/2005/Atom"\><title type="text"\>Publicly Listed Services</title\><subtitle type="text"\>This is the list of publicly\-listed services currently available\.</subtitle\><id\>uuid:e94a6ed9\-1ead\-4676\-bf10\-70ade98f6a23;id=56939</id\><updated\>2026\-02\-10T16:31:19Z</updated\><generator\>Service Bus 1\.1</generator\></feed\><br>**Exit Code:** 200<br><br>**Command:** az eventhubs namespace network\-rule\-set list \-\-resource\-group rg\-test\-storage \-\-namespace\-name eh\-test\-770646676<br>**Description:** Retrieve Event Hub namespace network rules<br>**Expected:** Network rule configuration with default action and IP/VNet rules<br>**Actual:** \{<br>"id": "/subscriptions/55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051/resourceGroups/RG\-Test\-Storage/providers/Microsoft\.EventHub/namespaces/eh\-test\-770646676/networkrulesets/default",<br>"location": "eastus",<br>"name": "default",<br>"resourceGroup": "RG\-Test\-Storage",<br>"type": "Microsoft\.EventHub/namespaces/networkRuleSets",<br>"defaultAction": "Allow",<br>"ipRules": null,<br>"virtualNetworkRules": null,<br>"trustedServiceAccessEnabled": false<br>\}<br>**Exit Code:** 0 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| sb\-test\-770646729 | microsoft\.servicebus/namespaces | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | defaultAction: allow<br>sku: <nil\><br>zoneRedundant: true<br>endpoint: https://sb\-test\-770646729\.servicebus\.windows\.net:443/<br>resourceGroup: rg\-test\-storage<br>publicNetworkAccess: enabled | **Command:** curl \-i 'https://sb\-test\-770646729\.servicebus\.windows\.net/$management' \-\-max\-time 10<br>**Description:** Test anonymous access to Service Bus management endpoint<br>**Expected:** 401 = authentication required \| 200 = anonymous access \| 404 = not found<br>**Actual:** Body: <feed xmlns="http://www\.w3\.org/2005/Atom"\><title type="text"\>Publicly Listed Services</title\><subtitle type="text"\>This is the list of publicly\-listed services currently available\.</subtitle\><id\>uuid:78cb0b2c\-d889\-456d\-b2ad\-6b8f818d49d8;id=2557360</id\><updated\>2026\-02\-10T16:31:32Z</updated\><generator\>Service Bus 1\.1</generator\></feed\><br>**Exit Code:** 200<br><br>**Command:** az servicebus namespace network\-rule\-set show \-\-resource\-group rg\-test\-storage \-\-namespace\-name sb\-test\-770646729<br>**Description:** Retrieve Service Bus namespace network rules<br>**Expected:** Network rule configuration with default action and IP/VNet rules<br>**Actual:** \{<br>"id": "/subscriptions/55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051/resourceGroups/RG\-Test\-Storage/providers/Microsoft\.ServiceBus/namespaces/sb\-test\-770646729/networkrulesets/default",<br>"location": "eastus",<br>"name": "default",<br>"resourceGroup": "RG\-Test\-Storage",<br>"type": "Microsoft\.ServiceBus/namespaces/networkRuleSets",<br>"defaultAction": "Allow",<br>"ipRules": null,<br>"virtualNetworkRules": null,<br>"trustedServiceAccessEnabled": false,<br>"publicNetworkAccess": "Enabled"<br>\}<br>**Exit Code:** 0<br><br>**Command:** az servicebus namespace show \-\-name sb\-test\-770646729 \-\-resource\-group rg\-test\-storage<br>**Description:** Azure CLI command to show Service Bus namespace details<br>**Expected:** Namespace details = accessible via Azure API \| Error = access denied<br>**Actual:** Manual execution required \- requires Azure CLI authentication<br>**Exit Code:** 0 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| nebula\-vuln\-718112 | microsoft\.apimanagement/service | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | developerPortalStatus: Enabled<br>publicNetworkAccess: Enabled<br>gatewayUrl: https://nebula\-vuln\-718112\.azure\-api\.net<br>developerPortalUrl: https://nebula\-vuln\-718112\.developer\.azure\-api\.net<br>skuName: Developer<br>skuCapacity: 1<br>resourceGroup: nebula\-test\-rg | **Command:** curl \-i 'https://nebula\-vuln\-718112\.developer\.azure\-api\.net' \-\-max\-time 15<br>**Description:** Test if Developer Portal is accessible<br>**Expected:** 200 = portal accessible \| 403 = blocked \| timeout = not reachable<br>**Actual:** Status: 200, Body preview: <p\>This is a home page of the Developer portal \- an automatically generated, fully customizable<br>website for publishing your API documentation where consumers can discover APIs, learn how to use<br>them, request access, and try them out\.</p\><br><p\>The content hasn't been published yet\. You can do so in "Developer portal" section of your API<br>Management Service in the Azure portal\.<br><a href="https://docs\.microsoft\.com/en\-us/azure/api\-management/api\-management\-howto\-developer\-portal" target="\_blank"\><br>Learn\.\.\.<br>**Exit Code:** 200<br><br>**Command:** curl \-i 'https://nebula\-vuln\-718112\.developer\.azure\-api\.net/signup' \-\-max\-time 15<br>**Description:** Test if signup page is accessible \(UI check\)<br>**Expected:** 200 = signup visible in UI \| 404 = signup hidden in UI \(but API may still work\!\) \| redirect = disabled<br>**Actual:** Status: 200, Body preview: <p\>This is a home page of the Developer portal \- an automatically generated, fully customizable<br>website for publishing your API documentation where consumers can discover APIs, learn how to use<br>them, request access, and try them out\.</p\><br><p\>The content hasn't been published yet\. You can do so in "De\.\.\.<br>**Exit Code:** 200<br><br>**Command:** curl \-X POST 'https://nebula\-vuln\-718112\.developer\.azure\-api\.net/signup' \\<br>\-H 'Content\-Type: application/json' \\<br>\-H 'Origin: https://nebula\-vuln\-718112\.developer\.azure\-api\.net' \\<br>\-\-data\-raw '\{"challenge":\{"testCaptchaRequest":\{"challengeId":"00000000\-0000\-0000\-0000\-000000000000","inputSolution":"AAAAAA"\},"azureRegion":"NorthCentralUS","challengeType":"visual"\},"signupData":\{"email":"nebula\-vuln\-probe@nonexistent\-invalid\-domain\.test","firstName":"Nebula","lastName":"Probe","password":"NebulaProbe123\!","confirmation":"signup","appType":"developerPortal"\}\}' \-\-max\-time 15<br>**Description:** Test signup API endpoint directly \(VULNERABILITY TEST \- GHSA\-vcwf\-73jp\-r7mv\)<br>**Expected:** 400 with captcha/challenge error = VULNERABLE \(API active despite UI disabled\)<br>404 = NOT vulnerable \(API disabled\)<br>200/201 = CRITICAL \- signup succeeded\!<br>409 = VULNERABLE \(conflict/duplicate\)<br>**Actual:** ASSESSMENT: VULNERABLE \- Signup API is ACTIVE \(captcha validation response\)<br><br>Status: 400<br>Response: \{"code":"ValidationError","message":"Captcha challenge validation failed\.","details":\[\{"target":"Captcha","message":"Captcha validation failed\. The captcha challenge has timed\-out, please try again\."\}\]\}<br>**Exit Code:** 400 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| cosmos\-test\-770647283 | microsoft\.documentdb/databaseaccounts | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | publicNetworkAccess: enabled<br>endpoint: https://cosmos\-test\-770647283\.documents\.azure\.com:443/<br>ipRules: none<br>enableFreeTier: false<br>disableLocalAuth: false<br>kind: GlobalDocumentDB | **Command:** curl \-i 'https://cosmos\-test\-770647283\.documents\.azure\.com:443/' \-\-max\-time 10<br>**Description:** Test anonymous access to Cosmos DB discovery endpoint<br>**Expected:** 401/403 = authentication required \| 200 = anonymous access enabled \(misconfiguration\) \| other = connection/network issues<br>**Actual:** Body: \{"code":"Unauthorized","message":"Required Header authorization is missing\. Ensure a valid Authorization token is passed\.\\r\\nActivityId: 26e7798f\-c56a\-4de0\-a35e\-d5ae97e181f5, Microsoft\.Azure\.Documents\.Common/2\.14\.0"\}<br>**Exit Code:** 401 |
...
| Resource Name | Resource Type | Location | Subscription | Details | Automated Triage |
|---------------|---------------|----------|--------------|---------|------------------|
| kv\-test\-770646186 | microsoft\.keyvault/vaults | eastus | 55669d9a\-8cb4\-4761\-b7eb\-0cc2d10b3051 | sku: standard<br>vaultUri: https://kv\-test\-770646186\.vault\.azure\.net/<br>hasPrivateEndpoints: 0<br>hasVnetRules: 0<br>bypass: None<br>defaultAction: allow<br>publicNetworkAccess: enabled | **Command:** curl \-i 'https://kv\-test\-770646186\.vault\.azure\.net/keys?api\-version=7\.4' \-\-max\-time 10<br>**Description:** Test Key Vault keys listing endpoint<br>**Expected:** 401 = authentication required \| 200 = anonymous access \(critical issue\) \| 403 = access denied<br>**Actual:** Body: \{"error":\{"code":"Unauthorized","message":"AKV10000: Request is missing a Bearer or PoP token\."\}\}<br>**Exit Code:** 401 |
