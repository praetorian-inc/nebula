...
* [nebula gcp recon subdomain-takeover](nebula_gcp_recon_subdomain-takeover.md)	 - Scan for dangling DNS records that could enable subdomain takeover across organization, folder, or project scope.
