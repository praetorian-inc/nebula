...
- [OWNS](../OWNS/) - Owned applications, groups, service principals
- [CAN_ESCALATE](../CAN_ESCALATE/) - Privilege escalation paths

### Incoming

- [CONTAINS](../CONTAINS/group-to-member.md) - Group memberships
...
- [Data Schema](../data-schema.md#21-azure_adusers-array) - JSON input format
- [Service Principal Nodes](service-principal.md) - Related identity type
- [Group CONTAINS Member](../CONTAINS/group-to-member.md) - Group membership edges
