...
func NewAuthenticatedClient(ctx context.Context, imageContext docker.DockerImage, opts ...client.Opt) (*client.Client, error) {
	return authenticate(ctx, imageContext, true, opts...)
}

func authenticate(ctx context.Context, imageContext docker.DockerImage, retry bool, opts ...client.Opt) (*client.Client, error) {
	dockerClient, err := client.NewClientWithOpts(opts...)
	if err != nil {
		return nil, err
	}
