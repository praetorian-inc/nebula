...
- [CONTAINS](../CONTAINS/subscription-to-rg.md) - Resource groups

### Incoming

- [CONTAINS](../CONTAINS/mg-to-subscription.md) - Parent management group
...
- [Data Schema](../data-schema.md#5-azure_resources-object) - JSON input format
- [Management Group Nodes](management-group.md) - Parent nodes
- [Resource Group Nodes](resource-group.md) - Child nodes
- [MG CONTAINS Subscription](../CONTAINS/mg-to-subscription.md) - Parent edge
- [Subscription CONTAINS RG](../CONTAINS/subscription-to-rg.md) - Child edges
- [HAS_PERMISSION RBAC](../HAS_PERMISSION/owner.md) - Subscription-level permissions
