...
See [data-schema.md](../data-schema.md) for complete JSON structure.
...
- [../data-schema.md](../data-schema.md) - JSON input format
- [../CONTAINS/](../CONTAINS/) - Hierarchy relationships between nodes
- [../HAS_PERMISSION/](../HAS_PERMISSION/) - Permission assignments
- [../overview.md](../overview.md) - Graph architecture overview
