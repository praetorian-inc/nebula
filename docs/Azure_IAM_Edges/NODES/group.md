...
- [CONTAINS](../CONTAINS/group-to-member.md) - Group members
- [HAS_PERMISSION](../HAS_PERMISSION/) - Role assignments, RBAC grants
- [CAN_ESCALATE](../CAN_ESCALATE/) - Privilege escalation paths

### Incoming

- [OWNS](../OWNS/group-ownership.md) - Group owners
- [CONTAINS](../CONTAINS/group-to-member.md) - Nested group memberships
- [HAS_PERMISSION](../HAS_PERMISSION/) - Transitive permissions from other groups
...
- [Data Schema](../data-schema.md#22-azure_adgroups-array) - JSON input format
- [Group CONTAINS Member](../CONTAINS/group-to-member.md) - Membership edges
- [Group Ownership](../OWNS/group-ownership.md) - Ownership edges
