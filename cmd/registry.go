...
func init() {
	...
	RegisterModule(azureReconCmd, reconaz.AzurePublicAccessMetadata, reconaz.AzurePublicAccessOptions, azureCommonOptions, reconaz.AzurePublicAccessOutputProviders, reconaz.NewAzurePublicAccess)
