...
- [CONTAINS](../CONTAINS/tenant-to-root-mg.md) - Root management group
...
- [Data Schema](../data-schema.md#1-collection_metadata-object) - JSON input format
- [Root Management Group](management-group.md) - Child node
- [Tenant CONTAINS Root MG](../CONTAINS/tenant-to-root-mg.md) - Hierarchy edge
- [CAN_ESCALATE to Tenant](../CAN_ESCALATE/global-administrator.md) - Privilege escalation
