...
- [CONTAINS](../CONTAINS/resource-to-system-mi.md) - Parent Azure resource
- [CAN_ESCALATE](../CAN_ESCALATE/) - From parent resource (via IMDS token theft)
...
- [Resource CONTAINS System MI](../CONTAINS/resource-to-system-mi.md) - Parent edge
