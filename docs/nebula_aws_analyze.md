...
* [nebula aws analyze apollo-report](nebula_aws_analyze_apollo-report.md)	 - Generates analysis reports from Apollo graph database including privilege escalation paths and external trust relationships
